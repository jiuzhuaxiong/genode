...
#ifndef _CORE__INCLUDE__SPARTAN__RM_SESSION_COMPONENT_H_
#define _CORE__INCLUDE__SPARTAN__RM_SESSION_COMPONENT_H_
...
#endif /* _CORE__INCLUDE__SPARTAN__RM_SESSION_COMPONENT_H_ */
